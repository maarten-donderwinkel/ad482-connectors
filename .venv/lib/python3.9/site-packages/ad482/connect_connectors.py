...
from .common.constants import KAFKA_CONNECT_CLUSTER_NAME


class ConnectConnectors(GuidedExercise):
    __LAB__ = "connect-connectors"

    """
    Creating Connectors Guided Exercise
    """
        ...
        items = [
            ...
            steps.delete_topics(
                ['my-connect-cluster-configs', 'my-connect-cluster-offsets',
                 'my-connect-cluster-status', 'github-events']
            ),
