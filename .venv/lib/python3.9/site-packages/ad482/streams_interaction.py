...
class StreamsInteraction(GuidedExercise):

    """
    Streams interaction exercise
    """

    __LAB__ = "streams-interaction"

    topics = ["payments", "large-payments"]

    def start(self):
        items = [
            steps.pull_apps_repo(),
            steps.copy_lab_app(self.__LAB__, "payments"),
            steps.check_ocp_api(),
